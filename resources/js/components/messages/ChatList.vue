<template>
    <div class="container py-8">
        ...
        <div class="card-list" id="chat-list">
            <a v-for="conversation in $root.conversations" v-bind:key="conversation.id" :href="'#'+ conversation.id"
                class="card border-0 text-reset" @click.prevent="setConversation(conversation)">
                <div class="card-body">
                    <div class="row gx-5">
                        <div class="col-auto">
                            <div class="avatar "
                        ...
                        <div class="col">
                            <div class="d-flex align-items-center mb-3">
                                <h5 class="me-auto mb-0">{{ conversation.participants[0].name}}
                                </h5>
                                <span
                                    class="text-muted extra-small ms-2">{{$root.moment(conversation.last_message.created_at)}}</span>
                            </div>
