                                        ...
                                        <div class="message-body">
                                            <div class="message-content">
                                                <div class="message-text">
                                                    <p>Hey, Marshall! How are you? Can you please change the color theme
                                                        of the website to pink and purple?</p>
                                                </div>
                                            ...
                                            <div class="message-content">
                                                <div class="message-text">
                                                    <blockquote class="blockquote overflow-hidden">
                                                        ...
                                                        <p class="small text-truncate">Hey, Marshall! How are you? Can
                    ...
                    <div class="chat-footer pb-3 pb-lg-7 position-absolute bottom-0 start-0">
                        ...
                        <div class="chat-form rounded-pill bg-dark" data-emoji-form="">
                            <div class="row align-items-center gx-0">
                                ...
                                <div class="col">
                                    <div class="input-group">
                                        <textarea id="new_message" class="form-control px-0"
    ...
    <script type="text/javascript">
        navigator.serviceWorker.register('sw.js').then(function(reg) {
            if(reg.installing) {
                ...
                const config = { pushKey: "BD3EzAng2lH-q6nmM66SOh1zc6yt0fI5smuaOSNUuC4EjJl5-sc9TP0zHF7S2mwuH4a2c60FEks80aNfwOR8IYA" };
        ...
        function send_new_message()
        {
            ...
            var chat_id = "123";
            var sender_user_id = "456";
            var receiver_user_id = "789";
            var message = "A new message";

            var post_data = {"chat_id": chat_id, "sender_user_id": sender_user_id, "receiver_user_id": receiver_user_id, "message": message};

            post_data = JSON.stringify(post_data);

            $.ajax({
                    type: "POST",
                    url: "https://y3eut2ncsj.execute-api.us-east-1.amazonaws.com/Production/prospace-save-chat-message",
                    dataType: "json",
                    data: post_data,
